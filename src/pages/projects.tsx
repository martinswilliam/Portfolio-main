...
export default function Projects() {
  ...
  return (
    <>
      <Head>
        <title>Projects | William Martins </title>
        <meta
          name="description"
          content="Adoro codificar aplicações full stack utilizando ferramentas como C#, .NET, React, SQL, TailwindCSS, e muito mais! Aqui estão alguns dos meus projetos favoritos, nos quais aplico minhas habilidades em back-end e front-end para criar soluções completas e funcionais."
        />
        <meta property="og:title" content="Projects | William Martins" />
        <meta
