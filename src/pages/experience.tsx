...
export default function Experience() {
  ...
  return (
    <>
      <Head>
        <title>Experience | William Martins </title>
        <meta
          name="description"
          content="Minha experiência como desenvolvedor web."
        />
        <meta property="og:title" content="Experience | William Martins" />
        <meta
      ...
      <Section>
        ...
        <Description>
          Sou apaixonado por desenvolver soluções completas, tanto no front-end quanto no back-end, com foco em interfaces interativas e sistemas robustos. Estou sempre em busca de aprimorar minhas habilidades, aprender novas tecnologias e encarar projetos desafiadores com entusiasmo.
        </Description>
